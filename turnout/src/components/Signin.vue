<template>
  <div class="form-inline">
    ...
    <div class="alert alert-danger" role="alert" v-if="error.message!=''">
      ...
      <br>
      <button class="btn btn-primary" style="margin-top:5px;" @click="signIn">Sign In</button>
    </div>
    <br>
    <br>
    <router-link style="margin-top: 5px, margin-botton: 5px" to="/signup">Not a user? Sign Up</router-link>
  </div>
</template>
